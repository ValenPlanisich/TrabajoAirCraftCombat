...
import MenuControles from "./public/scenes/MenuControles.js";
...
const config = {
  ...
  scene: [Preload,MenuPrincipal,Juego3,SeleccionNivel,Nivel1,Nivel2, NivelInfinito,Informacion, MenuControles,],
};
